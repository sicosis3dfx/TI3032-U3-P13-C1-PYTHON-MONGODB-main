...
def main():
    ...
    while True:
        ...
        opcion = input("Ingresa tu opcion [1-6, 0]: ")
        ...
        if opcion == "1":
            ...
            print(
                """
                ======================================
                |   PEDIDOS CON MONTO SUPERIOR $100   |
                ======================================
                """
            )
            pedidos_mayores_100()
            ...
            print(
                """
                ======================================
                |   PEDIDOS REALIZADOS EN EL AÑO 2023 |
                ======================================
                """
            )
            pedidos_año_2023()
            ...
            print(
                """
                ======================================
                |   PEDIDOS CON PRODUCTO ID = 101    |
                ======================================
                """
            )
            pedidos_con_producto_101()
            input("Presiona ENTER para continuar...")
        elif opcion == "6":
            subprocess.run(["cls"], shell=True, check=True)
            print(
                """
                ======================================
                | CONSULTA COMPLEJA: CLIENTES TOP    |
                ======================================
                """
            )
            clientes_pedidos_grandes_ultimo_año()
            input("Presiona ENTER para continuar...")
        elif opcion == "0":
            subprocess.run(["cls"], shell=True, check=True)
